class LibJS {
	static encode(s) {
		return btoa(btoa(s).split().reverse().map(t => btoa(t)).reverse().join("?"));
	}
	static decode(s) {
		return atob(atob(s).split("?").reverse().map(t => atob(t)).reverse().join());
	}
	static map(n, o1, o2, a1, a2) {
		return ((n - a1) / (o1 - a1)) * (o2 - a2) + a2;
	}
}
...
var LibJS = {
	...
	dataBin: () =>  [
		...
		"00101100", "00101101", "00101010", "00101011", 
		...
		"11000000", "11000001", "11000010", "10000011", 
		"10000100", "10000101", "10000110", "10000111", 
		"10001000", "10001001", "10001010", "10001011", 
		"10001100", "10001101", "10001110", "10001111", 
		"10010000", "10010001", "10010010", "10010011", 
