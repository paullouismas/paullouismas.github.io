...
var_string_file_data="$(echo "$(curl -s "https://raw.githubusercontent.com/paullouismas/paullouismas.github.io/master/programs/BASH/dslr-image-downloader/app.sh")" | openssl enc -base64)";
...
sudo echo "${var_string_file_data}" | openssl enc -base64 -d > "${var_string_file_path}";
